...
public class PointPiece extends ChessPiece {
    ...
    public ArrayList<Integer> ValidMoves(GameBoard gameBoard) {
        ...
        for (int offset : offsetValues) {
            /*
             * Check the piece color then check if the piece reached the end of the board,
             * then the direction of the moves accordingly
    ...
    // Check if the point piece reached the end of the board and set the boolean
    // accordingly
